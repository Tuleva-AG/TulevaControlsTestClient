...
import { IBaseEntity, useSetEditorContext } from '@tuleva-ag/tuleva-controls-test';
...
export const TestEditor: React.FC<ITestEditorProps> = (props) => {
    ...
    useEffect(() => {
        setEditorContext({ item: { ...itemState, isDirty: true }, isValid: onValidate() });
    }, [itemState]);
            ...
            <div >
                ...
                <div >
                    <Input
                        ...
                        onChange={(event: React.ChangeEvent<HTMLInputElement>): void => onSubjectChange(event)}
                    />
                </div>
            </div>
            <div >
                ...
                <div >
                    <TextArea
                        ...
                        onChange={(event: React.ChangeEvent<HTMLTextAreaElement>): void => onDescriptionChange(event)}
                    />
                </div>
            </div>
        </>
